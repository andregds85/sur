            ...
            <div class="card">
                ...
                @foreach ($itensP as $t)
                     ...
                     <div class="form-group row" required>
                            ...
                            <option selected>{{$t->macro}}</option>
                     ...
                     <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Fila_unidadeHospitalar" type="text" class="form-control @error('Fila_unidadeHospitalar') is-invalid @enderror" name="Fila_unidadeHospitalar" value="{{$t->Fila_unidadeHospitalar}}" required autocomplete="Fila_unidadeHospitalar">
                     ...
                     <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="unidade_hospitalarDesejada" type="text" class="form-control @error('unidade_hospitalarDesejada') is-invalid @enderror" name="unidade_hospitalarDesejada" value="{{$t->unidade_hospitalarDesejada}}" required autocomplete="unidade_hospitalarDesejada">
                    ...
                    <!--  dataInformacao_Depuracao -->
                     <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="unidade_hospitalarDesejada" type="text" class="form-control @error('dataInformacao_Depuracao') is-invalid @enderror" name="dataInformacao_Depuracao"  value="{{$t->dataInformacao_Depuracao}}" required autocomplete="dataInformacao_Depuracao">
                     ...
                     <!--  nligacoes -->
                       <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nligacoes" type="text" class="form-control @error('nligacoes') is-invalid @enderror" name="nligacoes" value="{{$t->nligacoes}}" required autocomplete="nligacoes">
                                @error('nligacoes')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
